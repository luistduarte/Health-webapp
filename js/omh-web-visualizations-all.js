    ...
    root[ parentName ] = factory( root, parentName );
        ...
        ChartInteractions = function ( element, primaryMeasure, configuration, parser, styles ) {
            ...
            var initializePanZoomInteraction = function () {
                ...
                panZoomHint = new Plottable.Components.Label( '( Arraste o Gráfico, ou faça Zoom in-out )', 0 )
                    .padding( 10 )
                    .yAlignment( 'bottom' )
                    .xAlignment( 'right' )
            ...
            var initializeToolbarInteraction = function () {
                ...
                if ( settings.toolbar.visible ) {
                    ...
                    if ( settings.toolbar.timespanButtons.visible ) {
                        ...
                        toolbar.append( "span" ).classed( "time-buttons-label", true ).text( "Mostrar: " );
                    ...
                    if ( settings.toolbar.navigationButtons.visible ) {
                        var $prevButton = toolbar.append( 'span', ":first-child" ).classed( 'previous-time-period-button', true ).text( '< anterior' );
                        $prevButton.on( 'click', function () {
                            shiftVisibleTimeByPercentageIncrement( -100 );
                        } );

                        var $nextButton = toolbar.append( 'span' ).classed( 'next-time-period-button', true ).text( 'próxima >' );
